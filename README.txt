...
更新履歴：
12/18/16:00/some addition
hpとspの初期位置が逆＆バイトアドレッシングになってなかった
メモリサイズを実際に近づけた
printinfoにhp,spのmax,minを追加
  spは1200程度、 hpは10,0000程度使っているぽい
writeはppmの初期設定が45万命令目くらい、実際の出力開始が1千万くらいかららしい
